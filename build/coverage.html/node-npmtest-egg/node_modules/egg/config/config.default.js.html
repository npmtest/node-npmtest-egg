...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-egg/node_modules/egg/config/config.default.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-egg/node_modules/egg/config/config.default.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-egg/node_modules/egg/config/</a> &#187; config.default.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  config.notfound = {</span>
    pageUrl: '',
  };
&nbsp;
  /**
   ...
   * };
   */
<span class="cstat-no" title="statement not covered" >  config.siteFile = {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  config.bodyParser = {</span>
    enable: true,
    encoding: 'utf8',
    formLimit: '100kb',
    jsonLimit: '100kb',
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  config.logger = {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  config.httpclient = {</span>
    keepAlive: true,
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  config.coreMiddleware = [</span>
    'meta',
    'siteFile',
    'notfound',
    'bodyParser',
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  config.workerStartTimeout = 10 * 60 * 1000;</span>
&nbsp;
